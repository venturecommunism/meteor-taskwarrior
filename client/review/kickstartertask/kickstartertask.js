...
Template.kickstartertask.editing = function () {
  return Session.equals('editing_itemname', this._id);
};

Template.kickstartertask.events({
...
Template.kickstartertask.is_kickstarter = function () {
  var truefalse = null
...
Template.kickstartertask.nokickstart = function () {
