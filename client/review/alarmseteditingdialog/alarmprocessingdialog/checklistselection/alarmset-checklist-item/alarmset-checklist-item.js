...
Template.alarmset_checklist_item.editing = function () {
  return Session.equals('editing_itemname', this._id);
};

Template.alarmset_checklist_item.events({
  'click input.checklistcheckbox': function (e, t) {
console.log('clicked 2k2')
...
Template.alarmset_checklist_item.checklistiteminpayload = function () {
